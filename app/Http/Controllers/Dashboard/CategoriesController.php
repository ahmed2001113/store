...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = Category::with('parent')
            ...
            // بنستخدم السيليكت رو علشان نحدد كولمز معينه بس مينفعش نسخدمها منغير سيلكت الاولي
            // فيه حاجه ثانيه اسمها ادد سيلكت و دي بنسخدمها علشان لو عايوين نكتب جمله سيلكت ثانيه
            //->select('categories.*')
            ...
            // دي بدل جمل السيلكت الي فوق بس لازم اكون عامل علاقه بين الموديلز
            // والفانكشن دي علشان ارجع الاكتيف بروداكت بس
            ->withCount([
     ...
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */// استخدمنا الموديل بدل الاي دي و مش لازم تعمل فاليديشن علي الاي دي لو استخدمتها
...
// استخدمنا الصلاحيات في الريكويست الي عملناه للابديت
        $category = Category::findOrFail($id);
