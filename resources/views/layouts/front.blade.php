...
<body>
    ...
    <!-- Start Breadcrumbs -->
    <!--زي الاسلوت بس علشان انادي عليها بكتب في الاتشايلد x-slot name"breadcrumb"" -->
    {{ $breadcrumb ?? '' }}
    <!-- End Breadcrumbs -->
{{-- بنستخدمها في الكمبوننت بدل السيكشن --}}
    {{ $slot }}
    ...
    {{-- علشان يجيب اكواد الاسكريبت الي في صفحه الهوم و استخدمنا ستاك بدل سلوت  --}}
    @stack('scripts')
